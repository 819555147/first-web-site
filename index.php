...
if(isset($_COOKIE["sid"]))							//用cookies传递sessionid
{
	...
	if(isset($_SESSION["username"])){		//设置session变量
		header("Location:index_loged.php");//跳转到未登录页面		
	}
	else{
		//不操作
	}
...
<html class="no-js" xmlns="index.php"  lang="zh-cmn-Hans"> 
	...
	<body>
					...
					<div class="nav-header">
						...
						<nav id="menu-wrap" role="navigation">
							<ul class="sf-menu" id="primary-menu">
								...
								<li>
									<a href="#" class="sub-ddown" onclick="window.location.href='login.php';"><i class="icon-user"></i>请先登录</a>
									<ul class="sub-menu">
										<li><a href="#" onclick="if(confirm('请先登录！')==true) window.location.href='login.php';"><i class="icon-feather"></i>个人中心</a></li>
										<li><a href="#" onclick="if(confirm('请先登录！')==true) window.location.href='login.php';"><i class="icon-feather"></i>发起约伴游</a></li>
										
										<li><a href="#" onclick="if(confirm('请先登录！')==true) window.location.href='login.php';"><i class="icon-feather"></i>我的关注</a></li>
										<li><a href="#" onclick="if(confirm('请先登录！')==true) window.location.href='login.php';"><i class="icon-feather"></i>广场</a></li>
									</ul>
								</li>
								<li>
									<a href="#" class="sub-ddown" onclick="if(confirm('请先登录！')==true) window.location.href='login.php';"><i class="icon-light-bulb"></i>分享之旅</a>
									 <ul class="sub-menu">
									 	<li><a href="#" onclick="if(confirm('请先登录！')==true) window.location.href='login.php';"><i class="icon-direction"></i>游记</a></li>
									 	<li><a href="#" onclick="if(confirm('请先登录！')==true) window.location.href='login.php';"><i class="icon-direction"></i>攻略</a></li>
										<li><a href="#" class="sub-ddown" onclick="if(confirm('请先登录！')==true) window.location.href='login.php';"><i class="icon-direction"></i>约伴游</a></li>
										<li><a href="#" onclick="if(confirm('请先登录！')==true) window.location.href='login.php';"><i class="icon-direction"></i>主题未定</a></li>
										<li><a href="#" onclick="if(confirm('请先登录！')==true) window.location.href='login.php';"><i class="icon-direction"></i>主题未定</a></li> 
									</ul>
								</li>
				...
				<div class="desc animate-box">
					...
					<script> <!--可以改成鼠标滑入显示-->
					    ...
					    document.getElementById("LXInfo").onmouseover=function(){
						    this.innerHTML="欢迎来到我们的网站！<br/><br/>";}
						document.getElementById("LXInfo").onmouseout=function (){
						    this.innerHTML=x;
						}	
					</script>
					
					<span><a class="btn btn-primary btn-lg" href="#" onclick="if(confirm('请先登录！')==true) window.location.href='login.php';">开始旅程</a></span>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-sm-4 item-wrap">
						<a class="listing-item" onclick="if(confirm('请先登录！')==true) window.location.href='login.php';">
		...
		<?php
			...
			$sql="SELECT Title,startDate FROM essay limit 0,3";	
			try {
			//链接数据库
				...
				<div class="row">
					<div class="col-md-6 news">
						...
						<ul>
							...
							<li>
								<a href="square.php#travels_here">
								    <br/>
